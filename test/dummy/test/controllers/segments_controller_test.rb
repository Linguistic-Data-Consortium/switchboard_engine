...
class SegmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create segment" do
    assert_difference("Segment.count") do
      post segments_url, params: { segment: { beg: @segment.beg, channel: @segment.channel, end: @segment.end, filename: @segment.filename, text: @segment.text, turn: @segment.turn } }
    end
  ...
  test "should update segment" do
    patch segment_url(@segment), params: { segment: { beg: @segment.beg, channel: @segment.channel, end: @segment.end, filename: @segment.filename, text: @segment.text, turn: @segment.turn } }
